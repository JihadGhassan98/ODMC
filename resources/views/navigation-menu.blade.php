<nav  x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex text-center">
                    <x-jet-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                        {{ App::isLocale('ar')? 'الرئيسية':'Main Panel' }}
                    </x-jet-nav-link>
                    ...
                    @if(Auth::user()->type == 2)
                    <x-jet-nav-link href="{{ url('/volunteer') }}" :active="request()->routeIs('volunteer')">
                    ...
                    @else
                    <x-jet-nav-link href="{{url('lang/en')}}">
                    English
                    </x-jet-nav-link>
                @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden ">
        ...
        <div class=" pb-1 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('appointments')">
            {{ App::isLocale('ar')? 'مواعيدي':'My Appointments' }}
            </x-jet-responsive-nav-link>
        </div>
        <div class=" pb-1 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('findVolunteer')">
            {{ App::isLocale('ar')? 'البحث عن متطوع':'Find A Companion' }}
            </x-jet-responsive-nav-link>
        </div>
        @if(Auth::user()->type == 2)
        <div class=" pb-1 space-y-1">
            <x-jet-responsive-nav-link href="{{ url('/volunteer') }}" :active="request()->routeIs('volunteerWithUs')">
            {{ App::isLocale('ar')? 'طلبات التطوع':'Volunteer Requests' }}
            </x-jet-responsive-nav-link>
        </div>
        @elseif(Auth::user()->type == 4)
